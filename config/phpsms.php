...
return [
    ...
    'agents' => [
        ...
        'Ucpaas' => [
            //主帐号,对应开官网发者主账号下的 ACCOUNT SID
            'accountSid' => '9392ff10f1020223c46adcf349d8d191',

            //主帐号令牌,对应官网开发者主账号下的 AUTH TOKEN
            'accountToken' => '04411522f5c3800871679d1a9391fe4f',

            //应用Id，在官网应用列表中点击应用，对应应用详情中的APP ID
            //在开发调试的时候，可以使用官网自动为您分配的测试Demo的APP ID
            'appId' => 'd0e47d5ca7ce487e8fa4443b1a655c7d',
            'verifySmsTemplateId' => '30557',
        ],
